  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4">
        <div className="w-full max-w-md p-8 bg-[#1e293b] border border-[#334155] rounded-lg text-center">
          ...
          <h2 className="text-xl font-bold text-[#e2e8f0] mb-2">Check your email</h2>
          <p className="text-[#94a3b8] mb-4">
            We've sent a confirmation link to <strong className="text-[#e2e8f0]">{email}</strong>.
            Please click the link to activate your account.
          </p>
          <button
            onClick={onSwitchToLogin}
            className="px-4 py-2 border border-[#334155] rounded-md text-[#94a3b8] hover:bg-[#334155] hover:text-[#e2e8f0] transition-colors"
          >
            Back to sign in
          </button>
        </div>
    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4">
      <div className="w-full max-w-md p-8 bg-[#1e293b] border border-[#334155] rounded-lg">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div>
            <label htmlFor="fullName" className="block text-sm font-medium text-[#94a3b8] mb-1">
              Full Name
            </label>
            <Input
              id="fullName"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-[#94a3b8] mb-1">
              Confirm Password
            </label>
            <Input
              id="confirmPassword"
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-[#1e293b] px-2 text-[#64748b]">Or sign up with</span>
          </div>
        </div>
